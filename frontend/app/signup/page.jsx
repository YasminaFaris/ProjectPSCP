    ...
    return(
       <div className="flex justify-center items-center min-h-screen bg-red-50 ">
            <div className="bg-white p-6 border border-zinc-300 rounded-xl max-w-[450px]">
                ...
                <input type="ID" className="w-full border border-zinc-300 px-4 p-2 mb-2 rounded-xl" placeholder="ID" />
                <input type="Usernaame" className="w-full border border-zinc-300 px-4 p-2 mb-2 rounded-xl" placeholder="Username" />
                ...
                <button className="bg-red-400 p-2 text-xl mb-4 w-full rounded-xl text-white">Sign Up</button>
